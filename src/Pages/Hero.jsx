  ...
  return (
    <div className="hero-container">
      <div className="content">
        <nav
          className={`${
            ctx.mediaWidth > 900 && ctx.scrollHeight > 900 ? "fix" : ""
          }`}
        >
          <div
            className={`nav_brand ${ctx.scrollHeight >= 650 ? "black" : ""}`}
          >
            <h3>Lucky Elliot</h3>
          </div>
          ...
          {menuIsDisplayed && (
            <div
              className="overlay"
              onClick={() => setMenuIsDisplayed(false)}
            ></div>
          )}
          {ctx.mediaWidth >= 900 && (
            <ul className="nav_links">
          ...
          {ctx.mediaWidth <= 900 ? (
            <button
              onClick={handleMenu}
              className={`toggler ${ctx.scrollHeight >= 650 ? "black" : ""}`}
            >
        ...
        <main>
          <div className="intro-cont">
            ...
            <div className="typing_text">
              <span>
                A <span id="typing">{displayedText}</span>
              </span>
              <span className="lobed_text"> Frontend Developer</span>
            </div>
            <p className="small-text">
              With 3+ Years of Personal & Collaborative Team experience <br />
